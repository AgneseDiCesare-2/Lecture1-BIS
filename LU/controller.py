...
class Controller:
    ...
    def gestisci_ordine(self, e):
        self._view._lvOut.controls.clear() #svuotiamo l'interfaccia grafica
        res, ordine =self._model.processa_prossimo_ordine() #dà in output True o False
        #NB: DOPPIO NOME
    ...
    def gestisci_all_ordini(self, e):
        ...
        if not ordini: #se ordini è vuota
